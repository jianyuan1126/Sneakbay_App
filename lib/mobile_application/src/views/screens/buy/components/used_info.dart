...
class UsedInfoWidget extends StatefulWidget {
  final ShoeModel shoeModel;
  final String selectedSize;

  const UsedInfoWidget({
    Key? key,
  ...
  @override
  _UsedInfoWidgetState createState() => _UsedInfoWidgetState();
}

class _UsedInfoWidgetState extends State<UsedInfoWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          ...
          .where('condition', isEqualTo: 'Used')
          .snapshots(),
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return Center(child: Text('No used listings found.'));
        }
